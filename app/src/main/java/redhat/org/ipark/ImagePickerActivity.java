...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public static void showImagePickerOptions(Context context, FragmentManager fragmentManager, PickerOptionListener listener) {
        ActionSheet.createBuilder(context, fragmentManager)
                .setCancelButtonTitle(R.string.cancel)
                .setOtherButtonTitles(context.getString(R.string.take_picture), context.getString(R.string.choose_from_gallery))
